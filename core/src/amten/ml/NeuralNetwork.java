...
public class NeuralNetwork implements Serializable{
    ...
    public void save()
    {
    	...
    	{
    		try {
				MatrixUtils.writeCSV(myThetas[i],"nn/Layer"+String.valueOf(i+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
    	}
    ...
    public void load()
    {
    	...
    	{
    		try {
    			myThetas[i] = MatrixUtils.readCSV("nn/Layer"+String.valueOf(i+1),',',0);
			} catch (IOException e) {
				e.printStackTrace();
			}
    	}
